...
app.layout = ddk.App(show_editor=True, children=[
    ddk.Header([
        ddk.Logo(
            src=app.get_relative_path('/assets/logo.png')
        ),
        ...
        ddk.Menu([
            html.A('USA.Gov', href='https://usa.gov')
        ]),
    ]),
    ...
    ddk.Card(
        ...
        children=[
            ...
            dcc.Tabs(children=[
                dcc.Tab(label='Top Domains (Past Week)', children=[
                    ddk.Graph(id='top-domains-weekly', figure={
                        'data': [{
                ...
                dcc.Tab(label='Top Domains (Past Month)', children=[
                    ddk.Graph(id='top-domains-monthly', figure={
                        'data': [{
                            'y': data.get_top_domains(days='30')['y'],
                            'x': data.get_top_domains(days='30')['x'],
                            'type': 'bar',
                            'orientation': 'h',
                            'transforms': [{
                                'type': 'sort',
                ...
                dcc.Tab(label='Top Pages (Now)', children=[
                    ddk.Graph(id='top-pages', figure={
                        'data': [{
        ...
        children=[
            ...
            ddk.Card(
                ...
                children=[
                    ...
                    ddk.Graph(id='visits-today', figure={
                        'data': [
                            {
            ...
            ddk.Card(
                ...
                children=[
                    ...
                    ddk.Graph(id='top-downloads', figure={
                        'data': [{
...
@callback(Output('top-downloads', 'figure'), Input('gov-agency', 'value'))
def update_visits_today(value):
    return {
        'data': [{
...
@callback(Output('visitor-locations', 'figure'), Input('gov-agency', 'value'))
def update_visits_today(value):
    return data.get_figure(dept=(value or 'live'))

@callback(Output('top-domains-weekly', 'figure'), Input('gov-agency', 'value'))
...
@callback(Output('top-domains-monthly', 'figure'), Input('gov-agency', 'value'))
...
@callback(Output('top-pages', 'figure'), Input('gov-agency', 'value'))
